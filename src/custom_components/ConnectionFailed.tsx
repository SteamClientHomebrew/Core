import { DialogButton, IconsModule } from "@millennium/ui";
...
export const ConnectionFailed = () => {
    return (
        <div className="__up-to-date-container" style={{
            ...
            <DialogButton onClick={() => SteamClient.System.OpenLocalDirectoryInSystemExplorer("ext\\data\\logs\\")} style={{width: "50%", marginTop: "20px"}}>Open Logs Folder</DialogButton>
        </div>
    );
}